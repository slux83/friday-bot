...
public class McocDayInfo {
    ...
    /**
     * @param aqStatus the aqStatus to set
     */
    ...
    /**
     * @param awStatus the awStatus to set
     */
    ...
    /**
     * @param catArenaStatus the catArenaStatus to set
     */
    ...
    /**
     * @param oneDayEventStatus the oneDayEventStatus to set
     */
    ...
    /**
     * @param threeDaysEventStatus the threeDaysEventStatus to set
     */
